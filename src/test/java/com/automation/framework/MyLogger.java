...
public class MyLogger {
	...
	public static synchronized void startTestCase(String sTestCaseName) {
		...
		System.setProperty("log.dir",System.getProperty("user.dir")+"/src/test/resources/Logs");
		startLog(System.getProperty("log.dir"), sTestCaseName);
	...
	private static void startLog(String dirPath, String testCaseName) {
		...
		noOfFiles++;
		String logFileName = dirPath+"/"+testCaseName + "_" + noOfFiles;
